...
public class UserVo {
	...
	public UserVo(int userno, String email, String userpw, String username, String phone, String regdate,
			String authority, String userxgps, String userygps) {
		this.userno = userno;
		this.email = email;
		this.userpw = userpw;
		this.username = username;
	...
	public String toString() {
		return "UserVo{" + "userno=" + userno + ", email='" + email + '\'' + ", userpw='" + userpw + '\''
				+ ", username='" + username + '\'' + ", phone='" + phone + '\'' + ", regdate='" + regdate + '\''
				+ ", authority='" + authority + '\'' + ", userx='" + userxgps + '\'' + ", usery='" + userygps + '\''
				+ '}';
	}
}
