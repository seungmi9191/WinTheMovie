	...
	<div class="modal-review-mask" id="review">
		<div class="modal-review-wrapper">
			<div class="modal-review-container">
				...
				<div class="star">
				    <i class="fa-star far" data-num="1"></i> 
					<i class="fa-star far" data-num="2"></i> 
					<i class="fa-star far" data-num="3"></i> 
					<i class="fa-star far" data-num="4"></i> 
					<i class="fa-star far" data-num="5"></i> 
				</div>
